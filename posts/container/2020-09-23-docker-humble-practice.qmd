...
![](https://raw.githubusercontent.com/anarinsk/lostineconomics-v2-1/master/images/docker-in-use/jupyter.png){ style="margin: auto; display: block; border:1.5px solid #021a40; width: 80%;" } 

RStudio도 그럴까? 그렇다. 원래 RStudio라는 IDE가 웹 기반으로 만들어졌기 때문에 이 역시 차이를 느낄 수 없다. 아래 화면에서 로그인을 하면 친숙한 RStudio의 화면이 뜬다. 

![](https://raw.githubusercontent.com/anarinsk/lostineconomics-v2-1/master/images/docker-in-use/rstudio_1.png){ style="margin: auto; display: block; border:1.5px solid #021a40; width: 80%;" }

![](https://raw.githubusercontent.com/anarinsk/lostineconomics-v2-1/master/images/docker-in-use/rstudio_2.png){ style="margin: auto; display: block; border:1.5px solid #021a40; width: 80%;" }
...
![](https://raw.githubusercontent.com/anarinsk/lostineconomics-v2-1/master/images/docker-in-use/docker_1.png){ style="margin: auto; display: block; border:1.5px solid #021a40; width: 80%;" }

아예 해당 이미지 및 컨테이너 데이터 전체를 리셋하는 방법도 있다. 

![](https://raw.githubusercontent.com/anarinsk/lostineconomics-v2-1/master/images/docker-in-use/docker_2.png){ style="margin: auto; display: block; border:1.5px solid #021a40; width: 80%;" }
