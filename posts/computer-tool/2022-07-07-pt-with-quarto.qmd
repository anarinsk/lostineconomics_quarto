...
:::{ .column-margin }
Quarto가 pandoc을 백엔드로 쓰기 때문에 문서의 거의 포맷으로 생성이 가능하다. Beamer의 `.tex`도 옮길 수 있다. html이 특별한 이유는 플랫폼을 불문하고 문서를 원래 의도 그대로 잘 전달할 수 있기 때문이다. 
:::
...
- 예제: [Completely Useless Quarto-Reveal.js](https://anarinsk.github.io/learn_quarto-revealjs/#/title-slide)
