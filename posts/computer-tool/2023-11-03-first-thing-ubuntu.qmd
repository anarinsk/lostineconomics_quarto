---
title: "Ubuntu를 깔고 제일 먼저 해야 할 일들" 
description: 우분투 설치할 일이 생각보다 많더라    
author: "JS HUHH"
date: "11/03/2023"
...
## TL; DR
우분투 설치하고 제일 먼저 해야 할 일들을 정리해보자.   

## 넋두리 
WSL이 생기면서 우분투를 서야 할 일이 생각보다 많다. 우분투 설치하고 먼저 해야 할 일은 정리해두겠다. 이 포스트 역시 까먹을 미래의 나 놈 때문이다. 
...
<https://docs.posit.co/resources/install-quarto/#__tabbed_1_2>
...
<https://github.com/anarinsk/setup_mojo>