...
`--index-url https://download.pytorch.org/whl/cu117`에 해당하는 부분을 Rye에서 별도로 설정할 수 있다. 자세한 내용은 [여기](https://github.com/anarinsk/test_pytorch-install#20230530-rye--vs-code)를 확인하도록 하자. 
:::
