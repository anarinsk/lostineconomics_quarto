...
프로젝트의 홈에 따르면 Quarto는 과학적 문서 작성을 위해 고안된 의존성을 최소화한 도구다. 앞서 소개한 BlogDown과 같은 툴이 RStudio와 같은 특정 도구에 의존한다면 이 녀석은 Jupyter, VS Code, RStudio 등 범용 에디터 및 도구와 함께 쓸 수 있다. 
