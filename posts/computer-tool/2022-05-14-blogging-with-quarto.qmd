...
:::{.column-margin}
Quarto의 기능은 생각보다 유연하고 다양하다. css나 js에 관한 지식이 부족해도 유용하게 활용할 다양한 기능을 갖추고 있다. [여기](https://quarto.org/docs/authoring/figures.html) 소개된 그림 배치에 관한 기능이 한 사례인데, 홈페이지에 "authoring" 항목을 살펴보도록 하자. 
:::
