...
`render` 명령어는 페이지를 렌더링하고 `preview`는 페이지를 미리 보여준다. [VS Code의 Quarto extension](https://marketplace.visualstudio.com/items?itemName=quarto.quarto)을 쓰면 해당 과정을 편리하게 진행할 수 있다. 
