...
{{< video https://www.youtube.com/watch?v=zxQyTK8quyY&t=133s >}}

## 넋두리 
타노스의 '핑거 스냅' 같은 느낌으로 회자되는 트랜스포머에 관해서 찍 먹해보자. 중요한 것은 트랜스포머의 구조를 이해하는 것, 그리고 RNN과 달리 왜 이 녀석에서는 parallelization이 가능한지를 이해하는 것이다. 
