...
::: {layout="[-1, 5, -1]"}
![네 개의 단어를 숫자로 바꿔자.](./images/w2v/w2v-1.png){ style="border: 1px solid #000;" }
:::

중요한 것은 '어떻게' 바꾸는지에 있다. 우선 강의 슬라이드에 나온대로 "Troll 2", "is", "great", "Gymkata" 네 개의 단어를 생각해보자. 
...
![신경망을 구성해보자.](./images/w2v/w2v-2.png){ style="border: 1px solid #000;" }

![신경망의 투입이 예측(뒤에 나올 단어)을 잘 맞출 수 있도록 네트워크의 웨이트를 조율해나간다.](./images/w2v/w2v-3.png){ style="border: 1px solid #000;" }
:::
...
::: {layout="[[5, -1, 5]]" layout-valign="bottom"}
![전체를 전부 학습하면 자원의 낭비가 막심하다!](./images/w2v/w2v-4.png){ style="border: 1px solid #000;" }

![Divide and Conquer! 그림에서 보듯이 "A"를 예측하기 위해서 "aardvark", "abandon"만을 남긴다. 산출에서 "aardvark"도 고려하지 않아도 된다. 이렇게 하면 학습해야 할 웨이트의 수가 300개로 줄어든다.](./images/w2v/w2v-5.png){ style="border: 1px solid #000;" }
:::
