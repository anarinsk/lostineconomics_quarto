...
The College Wealth Divide: Education and Inequality in America, 1956-2016 [download](https://www.stlouisfed.org/~/media/files/pdfs/hfs/is-college-worth-it/bartscher_kuhn_schularick_college_wealth_divide.pdf?la=en)
...
- 미국 연준에서 다운로드 받을 수 있는 [Survey of Consumer Finances](https://www.federalreserve.gov/econres/scfindex.htm)(SCF)라는 데이터가 있다. 이 데이터는 3년 간격으로 1983년부터 설문 자료를 수집하고 있는데, 여타 센서스와 같은 설문 항목과 비교해서 금용 관련된 상세한 내용을 담고 있다. 
...
![](https://github.com/anarinsk/aps-college_wealth/blob/master/assets/imgs/K-001.png?raw=true){ style="margin: auto; display: block; border:1.5px solid #021a40; width: 70%;" }
...
- 이는 소득과 부의 비율을 c와 nc로 나누어 비교한 그림2에서 보다 분명하게 드러난다.
 ...
 ![](https://github.com/anarinsk/aps-college_wealth/blob/master/assets/imgs/K-002.png?raw=true){ style="margin: auto; display: block; border:1.5px solid #021a40; width: 70%;" }
...
![](https://github.com/anarinsk/aps-college_wealth/blob/master/assets/imgs/K-003.png?raw=true){ style="margin: auto; display: block; border:1.5px solid #021a40; width: 70%;" }
...
![](https://github.com/anarinsk/acs-college_wealth/blob/master/assets/imgs/K-004.png?raw=true){ style="margin: auto; display: block; border:1.5px solid #021a40; width: 70%;" }
...
![](https://github.com/anarinsk/aps-college_wealth/blob/master/assets/imgs/K-007.png?raw=true){ style="margin: auto; display: block; border:1.5px solid #021a40; width: 70%;" }
...
![](https://github.com/anarinsk/aps-college_wealth/blob/master/assets/imgs/K-008.png?raw=true){ style="margin: auto; display: block; border:1.5px solid #021a40; width: 70%;" }
...
![](https://github.com/anarinsk/aps-college_wealth/blob/master/assets/imgs/K-010.png?raw=true){ style="margin: auto; display: block; border:1.5px solid #021a40; width: 70%;" }

- 그림 8에서 보듯이 c의 효과는 분명하다. 다만 소득 계층 기준으로 전체 집단의 효과가 50~90%의 중간 층에 비해  강하게 나타고 있다. 그림 9를 통해 이 내용을 다시 살펴보자. 


![](https://github.com/anarinsk/aps-college_wealth/blob/master/assets/imgs/K-009.png?raw=true){ style="margin: auto; display: block; border:1.5px solid #021a40; width: 70%;" }
...
![](https://github.com/anarinsk/aps-college_wealth/blob/master/assets/imgs/K-012.png?raw=true){ style="margin: auto; display: block; border:1.5px solid #021a40; width: 70%;" }
...
![유유상종과 부의 불평등](https://github.com/anarinsk/aps-college_wealth/blob/master/assets/imgs/K-006.png?raw=true){ style="margin: auto; display: block; border:1.5px solid #021a40; width: 70%;" }
