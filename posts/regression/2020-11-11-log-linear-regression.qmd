...
회귀분석에서 구하는 $\beta$와 위에서 얻은 $\beta$는 동일할 수가 없다. 왜나하면, $y_i$는 지수 함수라는 비선형 함수이기 때문이다. 일단 이 점을 기억해두도록 하자. 
 ...
 ![지수 함수의 접선의 기울기](https://dj1hlxw0wr920.cloudfront.net/userfiles/wyzfiles/7fd0a10d-1edf-487a-9d2a-4e52d68d181d.gif){ style="margin: auto; display: block; width: 70%;" }
