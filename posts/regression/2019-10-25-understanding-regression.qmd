...
![벡터 스페이스에 바라본 회귀 분석](https://github.com/anarinsk/lie-regression/blob/master/assets/imgs/reg-in-vectorspace.png?raw=true){ style="margin: auto; display: block; width: 60%;" }
...
![독립변수 1개인 회귀 분석](https://github.com/anarinsk/lie-regression/blob/master/assets/imgs/simpe_reg.png?raw=true){ style="margin: auto; display: block; width: 60%;" }
...
![2차원 컬럼 스페이스](https://miro.medium.com/max/2240/1*VUmUxo3G2UTugIiZ26Pusw@2x.jpeg){ style="margin: auto; display: block; width: 60%;" }
...
![잔차의 의미](https://github.com/anarinsk/lie-regression/blob/master/assets/imgs/regression-vector_comb.png?raw=true){ style="margin: auto; display: block; width: 60%;" }
