...
이 정리 참 아름답다. 전사 함수 $f(X)$에 존재하는 원소를 폭탄 삼아 잘못된 전제에서 출발한 명제를 폭파시키는 방식의 논법이다. 자세히 보면 이 정리는 러셀의 역설과 닮았다. 러셀이 칸토어의 해당 정리를 먼저 봤다고 하니, 레셀의 아이디어가 칸토어에서 왔다고 볼 수도 있을 듯 싶다. 
