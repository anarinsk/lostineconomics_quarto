...
![](https://github.com/anarinsk/lie-dot_product/blob/master/assets/images/perpendicularprojection.jpg?raw=true){ style="margin: auto; display: block; border:1.5px solid #021a40;" }

### From Definition to Geometry 

닷 프로덕트에 관한 설명은 정의에서 바로 코사인 법칙으로 넘어간다. 하지만 뭔가 분명하지 않다. 이걸 조금 더 풀어보자. 

![](https://betterexplained.com/wp-content/webp-express/webp-images/uploads/dotproduct/dot_product_components.png.webp){ style="margin: auto; display: block; border:1.5px solid #021a40;" }
...
![](https://betterexplained.com/wp-content/webp-express/webp-images/uploads/dotproduct/dot_product_rotation.png.webp){ style="margin: auto; display: block; border:1.5px solid #021a40;" }
...
:::{.column-margin}
[여기](https://math.stackexchange.com/questions/116133/how-to-understand-dot-product-is-the-angles-cosine)를 참고 했다. 
:::
...
![](https://github.com/anarinsk/lie-dot_product/blob/master/assets/images/hyperplane.jpg?raw=true){ style="margin: auto; display: block; border:1.5px solid #021a40; width: 60%;" }
