...
![](https://raw.githubusercontent.com/anarinsk/lostineconomics-v2-1/master/images/all-in-vs_code/avscode_1.png?raw=true){ style="margin: auto; display: block; border:1.5px solid #021a40; width: 80%;" }
...
![](https://raw.githubusercontent.com/anarinsk/lostineconomics-v2-1/master/images/all-in-vs_code/avscode_2.png?raw=true){ style="margin: auto; display: block; border:1.5px solid #021a40; width: 60%;" }

- 만일 위와 같은 화면에 Remote Exlorer에서 뜨지 않는다면 컨테이너가 부착되지 않는 것이다. 컨테이너를 부착하면 된다. 

![](https://raw.githubusercontent.com/anarinsk/lostineconomics-v2-1/master/images/all-in-vs_code/avscode_4.png?raw=true){ style="margin: auto; display: block; border:1.5px solid #021a40; width: 60%;" }
