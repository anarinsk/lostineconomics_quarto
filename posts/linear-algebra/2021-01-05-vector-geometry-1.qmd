...
![점에서 벡터를 생성해보자.](https://www.maths.usyd.edu.au/u/MOW/vectors/images/v120x.gif){ .my-figure7 }
...
![두 벡터의 크로스 프로덕트](http://mechanicsmap.psu.edu/websites/A1_vector_math/crossproduct/images/crossproduct.png){ .my-figure5 }
...
:::{ .column-margin }
크로스 프로덕트는 두 벡터와 직교하면서 두 벡터가 생성하는 면적을 적절하게 반영하는 길이를 지닌 벡터를 생성한다. 닷 프로덕트가 스칼라 값을 생성하는 것과 다르다는 점에 주의하자. [위키](https://en.wikipedia.org/wiki/Cross_product)를 참고하자.  
:::
