...
:::{layout="[-5, 10, -5]"}
![두 벡터의 크로스 프로덕트](https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Cross_product_parallelogram.svg/960px-Cross_product_parallelogram.svg.png){ style="margin: auto; display: block; border:0px solid #2d2d2d;" }
:::
