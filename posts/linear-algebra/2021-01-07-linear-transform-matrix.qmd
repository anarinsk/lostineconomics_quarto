...
author: "JS HUHH"
date: "01/07/2021"
image: "http://cau.ac.kr/~mhhgtx/courses/LinearAlgebra/images/LinearAlgebra.png"
categories: [linear-algebra]
#margin-header: subscribe.html
---

![function vs linear transformation](https://github.com/anarinsk/lostineconomics-v2-1/blob/master/images/linear-transform/matrix_func.png?raw=true){ style="margin: auto; display: block; border:1.5px solid #021a40; width: 80%;" }
...
![](https://github.com/anarinsk/lostineconomics-v2-1/blob/master/images/linear-transform/matrix_func_fig.png?raw=true){ style="margin: auto; display: block; border:1.5px solid #021a40; width: 60%;" }
...
![](https://github.com/anarinsk/lostineconomics-v2-1/blob/master/images/linear-transform/linearity.png?raw=true){ style="margin: auto; display: block; border:1.5px solid #021a40; width: 60%;" }
...
![](https://github.com/anarinsk/lostineconomics-v2-1/blob/master/images/linear-transform/sur_inj.png?raw=true){ style="margin: auto; display: block; border:1.5px solid #021a40; width: 60%;" }
