...
![Gram-Schmidt 분해](https://upload.wikimedia.org/wikipedia/commons/thumb/9/97/Gram%E2%80%93Schmidt_process.svg/450px-Gram%E2%80%93Schmidt_process.svg.png){ style="margin: auto; display: block; width: 80%;" }
...
![Gram-Schmidt 3차원 분해](https://gaussian37.github.io/assets/img/math/la/gram_schmidt_process/2.png){ style="margin: auto; display: block; width: 80%;" }
